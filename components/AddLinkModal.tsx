    ...
    >
      <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md m-4 relative border border-gray-700">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-100">Add New Link</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="add-link-name" className="block text-sm font-medium text-gray-400 mb-1">
              Name
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="add-link-url" className="block text-sm font-medium text-gray-400 mb-1">
              URL
            </label>
            <input
              type="url"
          ...
          <div className="mb-6">
            <label htmlFor="link-category" className="block text-sm font-medium text-gray-400 mb-1">
              Category
            </label>
            <Dropdown
              options={categories}

    ...
    >
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md m-4 relative">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-slate-800">Add New Link</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="add-link-name" className="block text-sm font-medium text-slate-700 mb-1">
              Name
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="add-link-url" className="block text-sm font-medium text-slate-700 mb-1">
              URL
            </label>
            <input
              type="url"
